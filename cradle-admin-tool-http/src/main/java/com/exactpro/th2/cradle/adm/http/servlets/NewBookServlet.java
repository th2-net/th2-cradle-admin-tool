...
import com.exactpro.th2.cradle.adm.http.modes.NewBookCreationHttpMode;
import com.exactpro.th2.cradle.adm.modes.AbstractMode;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;


public class NewBookServlet extends SimpleHttpServlet {

	private static final Logger logger = LoggerFactory.getLogger(NewBookServlet.class);

	public NewBookServlet(CradleStorage storage) {
		super(storage);
	}

	protected AbstractMode<?, ?> createMode() {
		return new NewBookCreationHttpMode();
	}
}
